...
public class TrajectoryRepo {
        ...
        public static final String trajectoryJSONRobot = Constants.pathRobot + "AutoBall2_test43path.wpilib.json";
        ...
        public static final Trajectory trajectoryFront = TrajectoryContainer
                        .makeTrajectory(Constants.pathRobot + "AutoBall2_test43path.wpilib.json");
